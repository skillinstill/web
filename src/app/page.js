            ...
            <section id="services" className="my-16">
                ...
                <div className="flex flex-wrap justify-center items-center my-16 gap-2 md:gap-12 max-w-screen-xl mx-auto">
                    {servicesData.map((service, idx) => (
                        <Link
                            ...
                            href={"/" + service.route}
                        >
                            <Image src={service.imgs[0]} alt={service.name} />
                        </Link>
                    ))}
                </div>
                ...
                <div>
                    <ImageWithSideContent
                        ...
                        details={servicesData[0].details}
                    />
                    <ImageWithSideContent
                        img={im2}
                        imgOnLeft={true}
                        ...
                        details={servicesData[1].details}
                    />
                    <ImageWithSideContent
                        img={im3}
                        ...
                        details={servicesData[2].details}
                    />
                    <ImageWithSideContent
                        img={im4}
                        imgOnLeft={true}
                        ...
                        details={servicesData[3].details}
                    />
                </div>
            </section>
